...
.DESCRIPTION
    ...
    PHASE 1 — Role-assignable group provisioning
        ...
        Existing groups are detected and skipped (never deleted or modified structurally).

    PHASE 2 — Group membership
        Ensures each group contains exactly the members defined in $GroupConfigs.
        Users already in the group are skipped. Users not found in the tenant are
        flagged as errors and skipped. For PIM4Groups groups, users are assigned as
        eligible members via EasyPIM instead of direct membership.

    PHASE 3 — Group role assignments
    ...
    PHASE 4 — PIM group policies (PIM4Groups only)
        Configures the activation policy for PIM4Groups groups:
...
# ===========================================================================
Write-Host ""
Write-Host "── PHASE 2: Group Membership ────────────────────────" -ForegroundColor Cyan
...
# ===========================================================================
Write-Host ""
Write-Host "── PHASE 3: Group Role Assignments ──────────────────" -ForegroundColor Cyan
...
# ===========================================================================
Write-Host ""
Write-Host "── PHASE 4: PIM Group Policies ──────────────────────" -ForegroundColor Cyan
...
foreach ($phase in $phases) {
    ...
    $phaseLabel = switch ($phase) {
        ...
        "P2" { "Phase 2 — Group Membership            " }
        "P3" { "Phase 3 — Group Role Assignments      " }
        "P4" { "Phase 4 — PIM Group Policies          " }
...
if ($totalErrors -gt 0) {
    Write-Host "Completed with $totalErrors error(s). Review ERR entries above." -ForegroundColor Red
    Write-Host ""
